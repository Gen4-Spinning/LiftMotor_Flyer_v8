...
void StartSixSectorObj_v8_Correction(sixSectorCntrl *sixSectorCntrlObj,sixSector *sixSectorObj,uint8_t direction){
	//Setup the sixSector Obj. Correction for v8 where for some reason going up needs the opposite of what was needed in
	// v7
	if (direction == CW){
		sixSectorCntrlObj->direction = CCW;
